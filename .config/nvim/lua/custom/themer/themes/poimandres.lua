...
M.base_16 = {
    ...
    base06 = M.base_30.base07 = M.base_30.ogwhite,
    ...
    base0E = M.base_30.base0F = M.base_30.ogwhite,
}

M.polish_hl = {
    treesitter = {
        ["@variable"] = { fg = M.base_30.ogwhite },
        ["@variable.builtin"] = { fg = M.base_30.    ["@function.call"] = { fg = M.base_30.purple },
        ["@keyword.return"] = { fg = M.base_30.green },
        ["@operator"] = { fg = M.base_30.    ["@keyword.operator"] = { fg = M.base_30.seablue },
    ...
    cmp = {
        ...
        CmpItemAbbrMatch = { fg = M.base_30.    CmpSel = { bg = M.base_30.one_bg2, link = "" },
    },
